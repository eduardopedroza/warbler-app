...
def profile():
    ...
    if form.validate_on_submit():
        ...
        g.user.header_image_url = form.data.header_image_url or g.user.header_image_url
...
def like_message(message_id):
    ...
    if msg.user_id == g.user.id:
        flash("Cannot like your own message.", "warning")
        return redirect('/')
...
def homepage():
    ...
    if g.user:
        followed_users = [u.id for u in g.user.following] + [g.user.id]
        messages = (Message
                    .query
